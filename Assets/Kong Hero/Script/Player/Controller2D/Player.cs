...
public class Player : MonoBehaviour, ICanTakeDamage {
    ...
    float _moveLeftTime=0;
    float _moveRightTime = 0;
    public int _foodAddHealth = 0;
    public float _runTime = 0.2f;
...
//		else if((Input.GetKeyUp (KeyCode.A) || Input.GetKeyUp (KeyCode.D)))
	...
	public void MoveLeft(){
        ...
        //		Flip ();
        //}
        _moveLeftTime = _runTime;
	}
    public void MoveLeftWrap()
    {
        if (isPlaying)
        {
            input = new Vector2(-1, 0);
	...
	public void MoveRight(){
        ...
        //		Flip ();
        //}
        _moveRightTime = _runTime;
	}
    public void MoveRightWrap()
    {
        if (isPlaying)
        {
            input = new Vector2(1, 0);
...
//		controller.SetForce(force);
    ...
    {
        Health = Mathf.Clamp(Health+num,0,maxHealth);
